				...
				<div class="container h-card media">
					...
					<div class="content is-large">
						<p>
							...
							<br>
							<span class="title is-4"> Chef, web mechanic, general mayhem maker.</span>
							<br>
							<span class="subtitle is-4">Welcome to my corner of the web, chronicling life in a digital world.</span>
					</div><!-- intro -->
					<nav class="level">
						<div class="level-left">
							<a href="https://twitter.com/miklb" class="icon twitter level-item is-large" title="Twitter" rel="me">
								<svg viewbox="0 0 512 512"><path d="M419.6 168.6c-11.7 5.2-24.2 8.7-37.4 10.2 13.4-8.1 23.8-20.8 28.6-36 -12.6 7.5-26.5 12.9-41.3 15.8 -11.9-12.6-28.8-20.6-47.5-20.6 -42 0-72.9 39.2-63.4 79.9 -54.1-2.7-102.1-28.6-134.2-68 -17 29.2-8.8 67.5 20.1 86.9 -10.7-0.3-20.7-3.3-29.5-8.1 -0.7 30.2 20.9 58.4 52.2 64.6 -9.2 2.5-19.2 3.1-29.4 1.1 8.3 25.9 32.3 44.7 60.8 45.2 -27.4 21.4-61.8 31-96.4 27 28.8 18.5 63 29.2 99.8 29.2 120.8 0 189.1-102.1 185-193.6C399.9 193.1 410.9 181.7 419.6 168.6z"></path></svg>
							</a>
							<a href="https://github.com/miklb" class="icon github leve-item is-large" title="GitHub" rel="me">
							...
							<a href="<?php bloginfo( 'atom_url' ); ?>" class="icon rss level-icon is-large" title="RSS"><svg viewbox="0 0 512 512"><path d="M201.8 347.2c0 20.3-16.5 36.8-36.8 36.8 -20.3 0-36.8-16.5-36.8-36.8s16.5-36.8 36.8-36.8C185.3 310.4 201.8 326.8 201.8 347.2zM128.2 204.7v54.5c68.5 0.7 124 56.3 124.7 124.7h54.5C306.7 285.3 226.9 205.4 128.2 204.7zM128.2 166.6c57.9 0.3 112.3 22.9 153.2 63.9 41 41 63.7 95.5 63.9 153.5h54.5c-0.3-149.9-121.7-271.4-271.6-271.9V166.6L128.2 166.6z"></path></svg>
							</a>
						</div><!-- .level-left -->
					</nav><!-- .level -->
				</div><!-- .media-content -->
